...
const ticketData: Ticket = {
  ...
  messages: [
    {
      id: 1,
      text: "سلام، پرداخت انجام شده ولی سفارش ثبت نشده.",
      time: "۱۴:۳۲",
      isSupport: false,
    ...
    {
      id: 2,
      text: "سلام، لطفا شماره پیگیری پرداخت را ارسال کنید.",
      time: "۱۴:۳۵",
      isSupport: true,
      senderName: "پشتیبانی",
    },
        ...
        <div className="flex items-center justify-center h-[calc(100vh-200px)]">
          <div className="text-center">
            ...
            <Link
              ...
              className="text-[#59D8C3] hover:underline mt-4 inline-block"
            >
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center justify-end gap-">
            <div>
              <Link
                href="/"
                className="flex items-center justify-self-end  w-1/2 gap-1.5 px-1 py-1 rounded-xl bg-[rgba(255,255,255,0.03)] border border-[#59D8C3]/20 text-[11px] mb-5   text-gray-400 hover:text-white hover:border-[#59D8C3]/40 transition-all duration-300"
              >
                <svg
                  width="12"
                  height="12"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr_280px] gap-4">
            ...
            <div>
              ...
              <div className="space-y-2.5">
                <div className="flex justify-between">
                  ...
                  <span className="text-[11px] font-medium text-[#59D8C3]">
                    #{ticket.ticketId}
                  </span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-[11px] font-medium text-white">
                    {ticket.customerPhone.slice(0, 4)}***
                    {ticket.customerPhone.slice(-4)}
                  </span>
                </div>
                <div className="flex justify-between">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-3 min-h-[400px]">
              ...
              {!isClosed &&
                ticket.messages.map((msg) => (
                  <div
                    key={msg.id}
                    className={`flex gap-2 ${msg.isSupport ? "flex-row" : "flex-row-reverse"}`}
                  >
                    ...
                    >
                      <p
                        className={`text-[10px] font-semibold mb-1 ${msg.isSupport ? "text-[#59D8C3]" : "text-gray-500"}`}
                      >
          ...
          <div className="rounded-2xl bg-[#0D1B17] border border-[#59D8C3]/20 p-4 flex flex-col gap-4">
            <div>
              ...
              {selectedPageStatus === "unassigned" ? (
                <div className="flex flex-col gap-3 p-3 rounded-3xl bg-yellow-900/10 text-yellow-400 border border-yellow-500/30">
                  <div className="flex flex-col items-center justify-center gap-2">
                    <span className="text-xs ">هنوز اختصاص داده نشده</span>
                    <button
                      onClick={() => setIsAssignModalOpen(true)}
                      className="flex items-center justify-center w-full text-xs py-1 px-3 rounded-2xl  bg-[#72d1cc]  text-black transition-colors"
                    >
                      ارجاع به کارمند
                    </button>
                  </div>
                ...
                <div className="flex items-center gap-3 p-3 rounded-3xl bg-[rgba(255,255,255,0.02)]">
                  <div className="relative flex-shrink-0">
                    <div className="w-9 h-9 rounded-full bg-[#59D8C3]/10 border border-[#59D8C3]/20 flex items-center justify-center">
                      <span className="text-[#59D8C3] text-xs font-bold">
                ...
                <div className="flex gap-3">
                  ...
                  <div className="pb-4">
                    <p className="text-sm font-medium text-white">
                      وضعیت به «در حال پیگیری» تغییر کرد
                    </p>
